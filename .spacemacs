...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (osx
      :variables osx-command-as       'control
     osx-option-as        'meta
...
before packages are loaded."
 ;; Required for python to work on Mac OS 
